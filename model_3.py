...
model = keras.Sequential([
    ...
    layers.Dense(512, activation='sigmoid', kernel_regularizer=keras.regularizers.l2(0.0005)),
    layers.Dropout(.5),
...
# %% Model evaluation
model.evaluate(test_gen, steps=STEP_SIZE_TEST)  # accuracy xx
