...
train_gen = train_data_gen.flow_from_dataframe(training_df, "./train/dog", "./train/cat", x_col='filename', y_col='category', target_size=imagex%imagey, class_mode='categorical', batch_size=batch)
